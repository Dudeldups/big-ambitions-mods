...
namespace BigHax
{
    internal sealed class BigHaxInvestmentLimitService
    {
        ...
        {
            "Conversation/Viewport/Content/PlayerMessageTemplate/InputTemplates/BankInvestment",
            "Entries (Scroll View)/Viewport/Content/PlayerMessageTemplate/InputTemplates/BankInvestment"
        };
        ...
        private static Transform? ResolveDialogTransform(string dialogPath)
        {
            ...
            return rootObject.transform.Find(relativePath);
        }
