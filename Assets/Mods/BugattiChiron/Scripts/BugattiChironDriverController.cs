...
internal sealed class BugattiChironDriverController : MonoBehaviour
{
    ...
    private void CreateDriver()
    {
        ...
        driverRoot = new GameObject("BugattiChiron_SeatedPlayer");
        ...
        poseGraph = PlayableGraph.Create("BugattiChiron seated player");
    ...
    private IEnumerator RecoverInvalidExitPlacement()
    {
        ...
        {
            context?.Logger.Warn(
                $"BugattiChiron driver vehicle={vehicle.GetInstanceID()}: " +
