...
internal static class FerrariSF90SpiderAudioModel
{
    ...
    internal const float CrackleIdleVolume = .006f;
    ...
    // twin-turbo V8 layers carry the audible engine character.
    ...
    // only the top end so the upper rev range gains growl without sounding shrill.
