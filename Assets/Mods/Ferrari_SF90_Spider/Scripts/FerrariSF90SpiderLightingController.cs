...
internal sealed class FerrariSF90SpiderLightingController : MonoBehaviour
{
    ...
    private const string FrontIndicatorRightName =
        "FerrariSF90Spider_Light_FrontIndicator_FR";
    private const string HeadlampsName = "FerrariSF90Spider_Light_Headlamps";
    private const string TailLightsName = "FerrariSF90Spider_Light_TailLights";
    private const string BrakeLightsName = "FerrariSF90Spider_Light_BrakeLights";
    private const string ThirdBrakeLightName = "FerrariSF90Spider_Light_ThirdBrakeLight";
    private const string ReverseLightsName = "FerrariSF90Spider_Light_ReverseLights";
    private const string RearIndicatorLeftName =
        "FerrariSF90Spider_Light_RearIndicator_RL";
    private const string RearIndicatorRightName =
        "FerrariSF90Spider_Light_RearIndicator_RR";
    ...
    private int ConfigureHeadlightBeams()
    {
        ...
        leftBeam = CloneBeam(-0.70f, "LeftHeadlightBeam");
        rightBeam = CloneBeam(0.70f, "RightHeadlightBeam");
    ...
    private Light? CloneBeam(float localX, string suffix)
    {
        ...
        clone.name = "FerrariSF90Spider_" + suffix;
        clone.transform.localPosition = new Vector3(localX, 0.54f, 2.12f);
    ...
    private void LogInfo(string message) =>
        FerrariSF90SpiderDiagnostics.Info(
            context,
            $"FerrariSF90Spider lighting vehicle='{vehicle?.name}' " +
            $"instance={vehicle?.GetInstanceID()}: {message}");

    private void LogWarning(string message) =>
        context?.Logger.Warn($"FerrariSF90Spider lighting vehicle='{vehicle?.name}' " +
                             $"instance={vehicle?.GetInstanceID()}: {message}");
