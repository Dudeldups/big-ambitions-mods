#!/usr/bin/env python3
"""Generate a firm European dual-tone road horn for the SF90 V20.

The previous 190/232 Hz pair read like a ship horn.  V20 moves back into road-
...
def main() -> None:
    # 242/304 Hz: firm/deep for a sports car, but firmly above the ship-horn
    # register.  High reed is cleaner and quieter so the pair sounds compact.
    write("HornLow", make_reed(242.0, (1.0, .30, .11, .038), .175))
    write("HornHigh", make_reed(304.0, (1.0, .19, .060), .120))
