...
internal sealed class KoenigseggJeskoDriverController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                lastFailure = reason;
                context?.Logger.Warn($"KoenigseggJesko driver vehicle={vehicle.GetInstanceID()} " +
    ...
    private void CreateDriver()
    {
        ...
        if (steeringWheel == null)
            throw new InvalidOperationException("Jesko steering-wheel seat reference is missing.");
        ...
        driverRoot = new GameObject("KoenigseggJesko_SeatedPlayer");
        ...
        poseGraph = PlayableGraph.Create("KoenigseggJesko seated player");
