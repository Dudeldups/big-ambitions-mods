...
public sealed class KoenigseggJeskoRuntime : MonoBehaviour
{
    ...
    private static readonly Dictionary<string, Vector3> WheelPlacementOverrides =
        ...
        {
            { "FrontLeft_WheelController", new Vector3(-0.8057338f, 0.387f, 1.2893513f) },
            { "FrontRight_WheelController", new Vector3(0.8059794f, 0.387f, 1.2893511f) },
            { "RearLeft_WheelController", new Vector3(-0.76666033f, 0.371f, -1.4039924f) },
            { "RearRight_WheelController", new Vector3(0.7669054f, 0.371f, -1.4039926f) },
            { "KoenigseggWheelFrontLeft", new Vector3(-0.8057338f, 0.387f, 1.2893513f) },
            { "KoenigseggWheelFrontRight", new Vector3(0.8059794f, 0.387f, 1.2893511f) },
            { "KoenigseggWheelRearLeft", new Vector3(-0.76666033f, 0.371f, -1.4039924f) },
            { "KoenigseggWheelRearRight", new Vector3(0.7669054f, 0.371f, -1.4039926f) },
            { "KoenigseggFixedCaliperFrontLeft", new Vector3(-0.8357338f, 0.447f, 1.2443513f) },
            { "KoenigseggFixedCaliperFrontRight", new Vector3(0.8359794f, 0.447f, 1.2443511f) },
            { "KoenigseggFixedCaliperRearLeft", new Vector3(-0.77666033f, 0.411f, -1.3239924f) },
            { "KoenigseggFixedCaliperRearRight", new Vector3(0.7769054f, 0.411f, -1.3239926f) },
        };
