...
internal sealed class LamborghiniRevueltoDriverController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                lastFailure = reason;
                context?.Logger.Warn($"LamborghiniRevuelto driver vehicle={vehicle.GetInstanceID()} " +
    ...
    private void CreateDriver()
    {
        ...
        if (steeringWheel == null)
            throw new InvalidOperationException("Revuelto steering-wheel seat reference is missing.");
        ...
        driverRoot = new GameObject("LamborghiniRevuelto_SeatedPlayer");
        ...
        poseGraph = PlayableGraph.Create("LamborghiniRevuelto seated player");
