...
internal static class LamborghiniRevueltoPrivateDriverSupport
{
    ...
    private static GameObject? CreateAiPrefab(GameObject playerPrefab)
    {
        ...
        clone.name = "LamborghiniRevueltoPrivateDriver";
        ...
        var requiredVisuals = new[]
        {
            ...
            "LamborghiniWheelFrontLeft",
            "LamborghiniWheelFrontRight",
            "LamborghiniWheelRearLeft",
            "LamborghiniWheelRearRight",
...
internal sealed class LamborghiniRevueltoPrivateDriverAppearance : MonoBehaviour
{
    ...
    {
        { "LamborghiniWheelFrontLeft", "FL" },
        { "LamborghiniWheelFrontRight", "FR" },
        { "LamborghiniWheelRearLeft", "BL" },
        { "LamborghiniWheelRearRight", "BR" },
    };
    ...
    internal void BindWheelVisuals()
    {
        ...
        BindCaliper("LamborghiniFixedCaliperFrontLeft", "LamborghiniWheelFrontLeft");
    ...
    private IEnumerator InitializePrivateDriverState()
    {
        for (var frame = 0; frame < InitializationFrameLimit; frame++)
        {
            ...
            if (candidate != null && candidate.vehicleInstance != null)
            {
                ...
                LamborghiniRevueltoPrivateDriverSupport.ReportAppearanceResult(
    ...
    private IEnumerator EnsureDepartureAfterDismissal()
    {
        ...
        if (dismissed && trafficVehicle != null && trafficVehicle.gameObject.activeInHierarchy)
        {
            ...
            if (privateDriver?.vehicleInstance != null)
            {
                ...
                LamborghiniRevueltoPrivateDriverSupport.ReportDeparturePaintResult(
                    colorName,
    ...
    private bool RestoreSavedVehicleColor(bool applySpecializedPaint)
    {
        ...
        if (LamborghiniRevueltoPrivateDriverSupport.TryResolveDriverColor(
                colorName,
