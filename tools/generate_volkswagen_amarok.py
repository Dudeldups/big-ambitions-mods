...
for a,b in [
    ...
    ('private const float VehicleBrakeForce = 2200f;','private const float VehicleBrakeForce = 2600f;'),
    ('private const float BrakeMaxTorque = 2200f;','private const float BrakeMaxTorque = 2600f;'),
    ...
    ('SetRelativeNumber(serialized, "powertrain.transmission._downshiftRPM", 5500f);','SetRelativeNumber(serialized, "powertrain.transmission._downshiftRPM", 1500f);'),
...
for a,b in [
 ...
 ('private const float TireFrictionCircleStrength = 1.02f;','private const float TireFrictionCircleStrength = 0.96f;'),
 ('private const float AntiRollBarForce = 9000f;','private const float AntiRollBarForce = 3800f;'),
 ('private const float FrontSuspensionTravel = 0.075f;','private const float FrontSuspensionTravel = 0.160f;'),
 ('private const float RearSuspensionTravel = 0.080f;','private const float RearSuspensionTravel = 0.180f;'),
 ('private const float FrontTireRadius = 0.35025f;','private const float FrontTireRadius = 0.382f;'),
