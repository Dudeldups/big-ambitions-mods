...
# The official track values describe wheel-center to wheel-center width; the
# requested final visual fitment adds only 1 cm outward per side.
...
print(f"Patched wheel inset: -0.010 m per side (1 cm outward; front X=±{front_x:.3f}, rear X=±{rear_x:.3f}).")
