...
for name, literal in {
    ...
    "WheelInset": "0f",
    "VehicleLinearDrag": "0.020f",
    "VehicleBrakeForce": "2700f",
    "BrakeMaxTorque": "2700f",
    "FrontForwardGrip": "1.08f",
    "RearForwardGrip": "1.05f",
    "FrontForwardStiffness": "1.12f",
    "RearForwardStiffness": "1.10f",
    "TireFrictionCircleStrength": "1.08f",
...
for pattern, replacement in {
    ...
    r'SetNumber\(serialized, "maxCargoCapacity", [^;]+;': 'SetNumber(serialized, "maxCargoCapacity", 24f);',
    ...
    r'SetBool\(serialized, "autoParkSupported", (?:true|false)\);': 'SetBool(serialized, "autoParkSupported", false);',
